...
public class FitnessTrainerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 1010, 620));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       int selectedRow = tblCustomerList.getSelectedRow();
        if(selectedRow >=0){
            FitnessTrainerWorkRequest request = (FitnessTrainerWorkRequest) tblCustomerList.getValueAt(selectedRow, 2);
